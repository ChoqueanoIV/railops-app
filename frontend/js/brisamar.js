...
function preencherFormulario(passagem) {
    if (passagem.terminal !== "BRISAMAR") {
        throw new Error("A passagem informada não pertence ao Brisamar.");
    }
    ...
    const mobile = formularioBrisamar.querySelector(
    ...
    document.getElementById("radios-operantes").value =
        passagem.detalhe.radios_operantes;
    document.getElementById("radios-inoperantes").value =
        passagem.detalhe.radios_inoperantes;
    document.getElementById("baterias").value = passagem.detalhe.baterias;
    document.getElementById("carregadores").value = passagem.detalhe.carregadores;
    document.getElementById("eots-disponiveis").value =
        passagem.detalhe.eots_disponiveis || "";
    document.getElementById("eots-avariados").value =
        passagem.detalhe.eots_avariados || "";
...
async function carregarEdicao() {
    ...
    try {
        ...
        exibirMensagemEnvio(error.message, "erro");
    }
}
